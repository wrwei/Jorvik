...
public final class TreeResource {
	...
	public static final String PROFILES_PATHMAP = "pathmap://MYTREE/"; //$NON-NLS-1$	
	
	public static final String PROFILE_PATH = PROFILES_PATHMAP+"tree.profile.example.profile.uml"; //$NON-NLS-1$

	public static final String PROFILE_URI = "http://tree.example/1.0"; //$NON-NLS-1$
...
//	public static final String QUDV_LIBRARY_ROOT_ID = "QUDV"; //$NON-NLS-1$
	...
	public static Model createSysMLModel(ResourceSet resourceSet, String resourceName, String modelName) {
		...
		Resource sysmlProfileResource = resourceSet.getResource(URI.createURI(TreeResource.PROFILE_PATH), true);
	...
	public static Package getFirstSysMLMatchingContainerProfiledBySysMLProfile(Element element){
		return getFirstMatchingContainerProfiledBy(element,TreeResource.PROFILE_URI);
	}
	...
	public static boolean isSysMLProfileApplied(Element element){
		return isProfiledByProfile(element,TreeResource.PROFILE_URI);
	}

...
public class SRMLCreationCommand extends ModelCreationCommandBase implements IModelCreationCommand {
	...
	protected void initializeModel(EObject owner) {
		...
		Profile sysml = (Profile) PackageUtil.loadPackage(URI.createURI(SRMLResource.PROFILE_PATH), owner.eResource().getResourceSet());
		if (sysml != null) {

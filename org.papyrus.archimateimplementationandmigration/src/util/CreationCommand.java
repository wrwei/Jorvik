...
public class CreationCommand extends ModelCreationCommandBase implements IModelCreationCommand {
	...
	public static final String PROFILES_PATHMAP = "pathmap://resources/archimateimplementationandmigration/";
	
	public static final String PROFILE_PATH = PROFILES_PATHMAP+ "model.profile.uml";

	public static final String PROFILE_URI = "=archimate-implementation-migration";
